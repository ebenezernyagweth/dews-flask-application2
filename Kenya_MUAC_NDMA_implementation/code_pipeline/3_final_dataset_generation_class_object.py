...
class WastingPrevalenceDatasetBuilder:
    ...
    def generate_seasonal_features_and_lags(self, season1, season2):
        ...
        # Merge seasonal columns back into merged_data instead of replacing it entirely
        seasonal_cols = [c for c in df.columns if c not in [id_col, 'year', 'month']]
