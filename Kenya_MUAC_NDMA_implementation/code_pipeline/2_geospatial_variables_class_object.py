...
#        plt.show()
        ...
        #     print("Please check:")
        #     print("1. Bucket name is correct: dews-muac-export")
        #     print("2. Service account has permissions on this bucket")
        #     print("3. Run: gsutil iam ch serviceAccount:YOUR-SA-EMAIL@my-dews-project.iam.gserviceaccount.com:objectAdmin gs://dews-muac-export")
